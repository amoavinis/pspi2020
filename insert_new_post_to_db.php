...
VALUES (\"".htmlentities($_SESSION["email"], ENT_QUOTES)."\",\"".htmlentities($_POST["title"], ENT_QUOTES)."\",\"".$_POST["content"]."\", \"".htmlentities($_POST["cityNames"], ENT_QUOTES)."\", \"".htmlentities($post_datetime, ENT_QUOTES)."\", \"".htmlentities($latitude,ENT_QUOTES)."\", \"".htmlentities($longitude,ENT_QUOTES)."\", NOW())
"
;
